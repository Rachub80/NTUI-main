    ...
    <div className="flex items-center justify-center min-h-52">
      <div className="relative flex items-center">
        <div className="bg-[#000] border border-white/30  rounded-2xl flex items-center justify-center w-14 h-14 p-4">
          <img src={logos[0]} alt="Visa logo" className="h-full w-full object-contain" />
        </div>
        ...
        <div className="relative bg-black border-2 border-white/70 rounded-2xl flex items-center justify-center w-16 h-16 p-4 overflow-hidden shadow-[0_0_15px_5px_#dbe0e2]">
          <img src={logos[1]} alt="Stripe logo" className="h-full w-full object-contain" />
          <motion.div
        ...
        <div className="bg-black border border-white/30 rounded-2xl flex items-center justify-center w-14 h-14 p-4">
          <img src={logos[2]} alt="Link by Stripe logo" className="h-full w-full object-contain" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col justify-center h-full items-center relative">
      ...
      <div className="text-left p-6 mt-4">
        <h1 className="text-white text-2xl font-bold mb-2">Stripe Checkout</h1>
        <p className="text-gray-400 text-lg">Create secure checkout sessions from matched items.</p>
      </div>
    </div>
  );
};
          ...
          <div className="flex flex-col justify-between h-full">
            <div className="mb-4 px-6 mt-6">
              <div className="flex justify-between items-center mb-6 pb-2">
                <h2 className="text-white/70 text-xl">Match Confidence</h2>
                <div className="flex items-center">
                  <div className="h-1 bg-black w-8 rounded-lg"></div>
                  <span className="ml-2 text-white/70 text-sm">Scores</span>
                </div>
              </div>
            ...
            <div className="text-left p-6 mt-4">
              <h1 className="text-white text-2xl font-bold mb-2">Best-Match Selection</h1>
              <p className="text-white/70 text-lg">Embeddings rank candidates and pick the closest product to the spoken intent.</p>
            </div>
          </div>
        </CardWithEffect>
          ...
          <CardWithEffect>
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="text-left p-6">
                <h1 className="text-white text-2xl font-bold mb-2">Gemini + Embeddings</h1>
                <p className="text-white/70 text-lg">Normalize the command and compare candidates with semantic vectors.</p>
              </div>
            </div>
          </CardWithEffect>
          <CardWithEffect>
